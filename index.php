<?php include 'header.php'; ?>
        ...
        <div class="banner-fade">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide banner-style-one">
                    <div class="banner-thumb bg-cover shadow dark" style="background: url(assets/img/bg.jpg);"></div>
                    <div class="shape">
    ...
    <!-- ============================================ -->
    <div class="feature-style-one-area default-padding" style="background-image: url(assets/img/shape/18.png);">
        <div class="container">
            <div class="row align-center">
                <div class="col-xl-3 col-lg-6">
                    <div class="feature-style-one-item">
                        <img src="assets/img/43331.jpg" alt="Image Not Found">
                    </div>
                </div>
                <div class="col-xl-6 col-lg-6 pl-50 pr-50 pl-md-15 pr-md-15 pl-xs-15 pr-xs-15">
                    <div class="feature-style-one-info">
                        <h2 class="title">Best Organic <br> Agriculture Firms</h2>
                        <p>
                        ...
                        <a class="btn btn-theme mt-30 btn-md radius animation" href="about-us.html">Discover More</a>
                    </div>
                </div>
                    ...
                    <div class="featured-product">
                        ...
                        <div class="product-list-item">
                            <a href="services-details.html">
                                <img src="assets/img/icon/17.png" alt="Icon">
                                <h5>Blueberry</h5>
                            </a>
                        </div>
                        <!-- End Single Item -->
                        ...
                        <div class="product-list-item">
                            <a href="services-details.html">
                                <img src="assets/img/icon/18.png" alt="Icon">
                                <h5>Strawberry</h5>
                            </a>
                        </div>
                        <!-- End Single Item -->
                        ...
                        <div class="product-list-item">
                            <a href="services-details.html">
                                <img src="assets/img/icon/19.png" alt="Icon">
                                <h5>Maize</h5>
                            </a>
                        </div>
                        <!-- End Single Item -->
                        ...
                        <div class="product-list-item">
                            <a href="services-details.html">
                                <img src="assets/img/icon/20.png" alt="Icon">
                                <h5>Apples</h5>
                            </a>
                        </div>
                        <!-- End Single Item -->
    ...
    <div class="services-style-one-area bg-gray default-padding bottom-less">
        ...
        <div class="container">
            ...
            <div class="row">
                <!-- Single Item -->
                <div class="col-lg-5 col-md-6 service-one-single">
    ...
    <!-- Start Benifits 
    ============================================= -->
    <div class="benifits-area default-padding-top video-bg-live bg-cover mt--50 mt-md-0 mt-xs-0" style="background-image: url(assets/img/3966816.jpg);">
                    ...
                    <div class="col-lg-6 offset-lg-1">
                        <div class="product-cat-lists text-light">
                            <div class="product-list-box">
                                ...
                                <div class="product-list-item">
                                    <a href="services-details.html">
                                        <img src="assets/img/oil.png" alt="Icon">
                                        <h5>Blueberry</h5>
                                    </a>
                                </div>
                                <!-- End Single Item -->
                                ...
                                <div class="product-list-item">
                                    <a href="services-details.html">
                                        <img src="assets/img/medicine.png" alt="Icon">
                                        <h5>Strawberry</h5>
                                    </a>
                                </div>
                                <!-- End Single Item -->
                                ...
                                <div class="product-list-item">
                                    <a href="services-details.html">
                                        <img src="assets/img/medicine1.png" alt="Icon">
                                        <h5>Cabbage</h5>
                                    </a>
                                </div>
                                <!-- End Single Item -->
                                ...
                                <div class="product-list-item">
                                    <a href="services-details.html">
                                        <img src="assets/img/aid.png" alt="Icon">
                                        <h5>Maize</h5>
                                    </a>
                                </div>
                                <!-- End Single Item -->
                                ...
                                <div class="product-list-item">
                                    <a href="services-details.html">
                                        <img src="assets/img/syringe.png" alt="Icon">
                                        <h5>Orange</h5>
                                    </a>
                                </div>
                                <!-- End Single Item -->
            ...
            <div class="row align-center">
                <div class="col-xl-5 col-lg-5">
                    <div class="choose-us-thumb">
                        <img class="distributor-img" src="assets/img/stethoscope-with-different-pharmaceutical-stuff.jpg" alt="Image Not Found">
                    </div>
                </div>
