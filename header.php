            ...
            <div class="container-full d-flex justify-content-between align-items-center">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index-2.html">
                        ...
                        <img src="assets/img/logo.png" class="logo logo-mobile" alt="Logo">
                    </a>
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="index-2.html">Home Agriculture</a></li>
                                <li><a href="index-3.html">Home Farming</a></li>
                                <li><a href="index-4.html">Agriculture Shop</a></li>
                                <li><a href="index-5.html">Dairy Farm</a></li>
                            </ul>
                        </li>
                        <li class="dropdown">
